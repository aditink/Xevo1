...
//    private var mAuth: FirebaseAuth? = null
    ...
    //Database and authorization references
            ...
            mAuth!!
                    ...
                    .addOnCompleteListener(this) { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(this@LoginFirebase, "Authentication failed.",
    ...
    private fun updateUserInfoAndUI() {
        //start next activity
        val intent = Intent(this@LoginFirebase, MainActivity::class.java)
    ...
    private fun verifyEmail() {
        ...
        mUser!!.sendEmailVerification()
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        Toast.makeText(this@LoginFirebase,
